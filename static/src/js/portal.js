odoo.define('gts_hr_portal.hr_portal', function(require) {
    ...
    $(document).ready(function() {
        ...
        $("#select_permission_status_id").change(function(event){
            var holiday_status_id = $('#select_permission_status_id').val();
            console.log('holiday_status_id........' + holiday_status_id);
            var employee_id = $('#hidden_employee_id').val();
            console.log('employee_id........' + employee_id);
            if (!holiday_status_id) {
...
//            console.log('holiday_status_id........' + holiday_status_id);
            ...
            if (request_date_from != null && request_date_to != null && request_date_to != '' && request_date_to < request_date_from) {
